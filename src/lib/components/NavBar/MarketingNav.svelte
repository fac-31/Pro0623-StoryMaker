...
<div class="hidden items-center space-x-4 md:flex">
	...
	<a href="/signup" class="btn btn-primary"> Start Creating </a>
</div>
...
{#if mobileMenuOpen}
	<div class="border-base-300 bg-base-100 border-t md:hidden">
		<div class="space-y-4 px-4 py-4">
			<a href="#features" class="text-base-content/70 hover:text-primary block" on:click={() => setTimeout(() => mobileMenuOpen = false, 100)}>Features</a>
			<a href="#how-it-works" class="text-base-content/70 hover:text-primary block" on:click={() => setTimeout(() => mobileMenuOpen = false, 100)}>How it Works</a>
			<a href="#testimonials" class="text-base-content/70 hover:text-primary block" on:click={() => setTimeout(() => mobileMenuOpen = false, 100)}>Testimonials</a>
