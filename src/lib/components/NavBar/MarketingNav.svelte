...
<nav class="hidden items-center space-x-8 md:ml-8 md:flex" aria-label="Main navigation">
	...
	<a
		href="#testimonials"
		class="text-base-content/70 hover:text-primary transition-colors"
		role="button">Testimonials</a
	>
</nav>

<div class="hidden items-center space-x-4 md:flex">
	<a href="/login" class="btn btn-ghost min-h-[44px]" role="button">Sign In</a>
	<a href="/signup" class="btn btn-primary min-h-[44px]" role="button">Start Creating</a>
</div>
...
>
	<div class="space-y-4 px-4 py-4">
		<a
			...
			on:click={() => setTimeout(() => closeMobileMenu(), 100)}
			role="button">Features</a
		>
		<a
			href="#how-it-works"
		...
		<div class="border-base-200 space-y-2 border-t pt-4">
			<a href="/login" class="text-base-content/70 block w-full text-left" role="button">Sign In</a>
			<a href="/signup" class="btn btn-primary min-h-[44px] w-full" role="button">Start Creating</a>
		</div>
	</div>
</nav>
