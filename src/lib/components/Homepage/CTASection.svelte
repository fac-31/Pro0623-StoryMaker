...
<section
	class="bg-gradient-to-r from-purple-600 to-blue-600 py-20"
	role="region"
	aria-labelledby="cta-heading"
>
	<div class="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
		<div class="space-y-8">
			<h2 id="cta-heading" class="text-3xl font-bold text-white lg:text-5xl">
			...
			<div class="flex flex-col justify-center gap-4 sm:flex-row">
				<a href="/signup" class="btn btn-secondary btn-lg" aria-label="Start Creating for Free">
